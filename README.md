...
- 🏙️ **National Finalist:** Represented Bengaluru on the national stage, building end-to-end solutions under intense time constraints.
- 🎯 **RIFT 2026 Shortlist:** Recognized for building an Autonomous CI/CD Healing Agent with Team *Algo Ninjas*.
...
**Backend & DB:** Node.js, FastAPI, Prisma ORM, PostgreSQL, MongoDB  
**AI & APIs:** OpenAI API, LLMs, TensorFlow, TensorFlow Lite  
**Other:** Git, Clerk Auth, CI/CD, REST APIs, Postman  
...
> “Code. Learn. Build. Repeat.” — My daily cycle 🚀
